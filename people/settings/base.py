...
from people.settings.utils import get_logger_config
...
SECRET_KEY = os.environ.get('PEOPLE_SECRET_KEY', 'insecure-secret-key')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                'people.apps.core.context_processors.core',
            ),
...
CSRF_COOKIE_NAME = 'people_csrftoken'
LANGUAGE_COOKIE_NAME = 'people_language'
