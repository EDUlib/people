...
from people.settings.base import *
from people.settings.utils import get_env_setting, get_logger_config
...
# This may be overridden by the YAML in people_CFG,
# but it should be here as a default.
MEDIA_STORAGE_BACKEND = {}
FILE_STORAGE_BACKEND = {}

CONFIG_FILE = get_env_setting('PEOPLE_CFG')
