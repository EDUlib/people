# -*- coding: utf-8 -*-
#
# People service documentation build configuration file, created by
...
latex_documents = [
    ('index', 'people.tex', u'People service Documentation',
     u'edX', 'manual'),
]
...
man_pages = [
    ('index', 'People service', u'People service Documentation',
     [u'edX'], 1)
]
...
texinfo_documents = [
    ('index', 'People service', u'People service Documentation',
     u'edX', 'People service', 'People service',
     'Miscellaneous'
     ),
]
